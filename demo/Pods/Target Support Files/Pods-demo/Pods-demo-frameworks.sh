...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/ChannelizeAPI/Channelize_API.framework"
  install_framework "${PODS_ROOT}/ChannelizeCall/Channelize_Voice_Video.framework"
  install_framework "${PODS_ROOT}/ChannelizeUI/Channelize.framework"
