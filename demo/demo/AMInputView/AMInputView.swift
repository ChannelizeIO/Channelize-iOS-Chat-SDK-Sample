...
@IBDesignable class AMInputView: UIView,UITextFieldDelegate {
    ...
    private func setViewExpandMode(expand:Bool){
        ...
        backViewHeightExpandConstraint.priority = expand ? UILayoutPriority(rawValue: 500):UILayoutPriority(rawValue: 200)
        labelViewHTopExpandConstraint.priority = expand ? UILayoutPriority(rawValue: 500):UILayoutPriority(rawValue: 200)
        labelViewRightExpandConstraint.priority = expand ? UILayoutPriority(rawValue: 500):UILayoutPriority(rawValue: 300)
        labelViewLeftExpandConstraint.priority = expand ? UILayoutPriority(rawValue: 999):UILayoutPriority(rawValue: 300)
